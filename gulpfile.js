...
gulp.task('serve', shell.task(['python3 stattracker/manage.py runserver']));
...
gulp.task('deploy', function() {
  return gulp.src('stattracker/static/**/*').pipe(ghPages());
});
...
gulp.task('scss', function () {
  return gulp.src('./src/css/main.scss')
    ...
    .pipe(gulp.dest('stattracker/static/css'));
});
...
gulp.task('js', function () {
  ...
  return stream
    ...
    .pipe(gulp.dest('stattracker/static/js'));
});
...
gulp.task('html', function () {
  return gulp.src([src.allHtml, '!' + src.allViews])
    .pipe(gulp.dest('stattracker/static'));
});
