...
"use strict";var $=require("jquery"),_=require("underscore"),views=require("views"),router=require("../router"),show=require("../show"),getCookie=require("../csrf.js");router.route("activities/:id/stats",function(e){show("stats");var t=getCookie("csrftoken");$(".main-content").on("submit",".stat-form",function(r){r.preventDefault(),alert($(".stat-input").val()),$.ajax({beforeSend:function(e){e.setRequestHeader("X-CSRFToken",t)},method:"POST",url:"/api/stats/",data:{activity_id:e,value:$(".stat-input").val()}}).done(function(){alert("success")})})});
