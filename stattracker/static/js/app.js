...
"use strict";var $=require("jquery"),_=require("underscore"),views=require("views"),router=require("../router"),show=require("../show"),getCookie=require("../csrf.js");router.route("activities/:id",function(e){var i=getCookie("csrftoken");$.ajax({method:"GET",url:"/api/activities/"+e}).done(function(e){show("detail-template",{activity:e})}),$(".main-content").on("click",".rmv-btn",function(){console.log("hello"),$.ajax({beforeSend:function(e){e.setRequestHeader("X-CSRFToken",i)},method:"DELETE",url:"/api/activities/"+e}).done(function(){console.log("great")})})});

},{"../csrf.js":5,"../router":7,"../show":8,"jquery":"jquery","underscore":"underscore","views":"views"}],2:[function(require,module,exports){
