...
"use strict";var $=require("jquery"),_=require("underscore"),views=require("views"),router=require("../router"),show=require("../show"),getCookie=require("../csrf.js");router.route("activities/:id",function(e){var i=getCookie("csrftoken");$.ajax({method:"GET",url:"/api/activities/"+e}).done(function(e){show("detail-template",{activity:e})}),$(".main-content").on("click",".rmv-btn",function(){$.ajax({beforeSend:function(e){e.setRequestHeader("X-CSRFToken",i)},method:"DELETE",url:"/api/activities/"+e}).done(function(){window.location.href="#/activities"})})});

},{"../csrf.js":6,"../router":8,"../show":9,"jquery":"jquery","underscore":"underscore","views":"views"}],2:[function(require,module,exports){
...
},{"../csrf.js":6,"../router":8,"../show":9,"jquery":"jquery","underscore":"underscore","views":"views"}],3:[function(require,module,exports){
...
},{"../router":8,"../show":9,"jquery":"jquery","underscore":"underscore","views":"views"}],4:[function(require,module,exports){
...
},{"../csrf.js":6,"../router":8,"../show":9,"jquery":"jquery","underscore":"underscore","views":"views"}],5:[function(require,module,exports){
"use strict";var $=require("jquery"),_=require("underscore"),views=require("views"),router=require("../router"),show=require("../show"),getCookie=require("../csrf.js");router.route("user",function(){show("registration")});

},{"../csrf.js":6,"../router":8,"../show":9,"jquery":"jquery","underscore":"underscore","views":"views"}],6:[function(require,module,exports){
...
"use strict";var router=require("./router");({controllers:{"detail-activity":require("./controllers/detail-activity.js"),"edit-activity":require("./controllers/edit-activity.js"),"home-activities":require("./controllers/home-activities.js"),"new-activity":require("./controllers/new-activity.js"),reistration:require("./controllers/reistration.js")}}),router.init();

},{"./controllers/detail-activity.js":1,"./controllers/edit-activity.js":2,"./controllers/home-activities.js":3,"./controllers/new-activity.js":4,"./controllers/reistration.js":5,"./router":8}],8:[function(require,module,exports){
